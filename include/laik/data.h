...
// custom layout: layout_data for application-specific data
typedef Laik_Layout *(*laik_layout_factory_t)(int n, Laik_Range *, void *layout_data);
...
typedef enum _Laik_Use_Layout_t
{
    LAIK_Lex_Layout = 0,
    LAIK_Vector_Layout,
    LAIK_Sparse_Layout,
...
void laik_data_set_layout_flag(Laik_Data *d, Laik_Use_Layout_t);
...
// sparse layout covering 1d ranges

// // create layout object for 1d sparse layout
// Laik_Layout *laik_new_layout_sparse(int n, Laik_Range *ranges, void *layout_data);

// // return number of rows in the given layout
// uint64_t laik_get_nrows_sparse(Laik_Layout *l);

// // return array containing number of non zeros for each row in the given layout
// char *laik_get_nnz_sparse(Laik_Layout *l);

// // return maximum number of non zeros per row in the given layout
// int laik_get_maxRowSize_sparse(Laik_Layout *l);

// // Data struct for void *layout_data
// typedef struct _Laik_Sparse_Data Laik_Sparse_Data;
// struct _Laik_Sparse_Data
// {
//     uint64_t nrows;
//     char *numberOfNonZerosPerRow; // TODO change to Laik_Data container
//     int maxRowSize;
// };

// vector layout covering 1d ranges

// create layout object for 1d vector layout
Laik_Layout *laik_new_layout_vector(int n, Laik_Range *ranges, void *layout_data);
